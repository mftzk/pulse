...
type Config struct {
	...
	TurnstileSecret  string        // Cloudflare Turnstile secret; signup captcha is enforced only when set
	TurnstileSiteKey string        // Cloudflare Turnstile site key, exposed to the browser via /api/auth/config
